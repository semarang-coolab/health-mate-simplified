package id.health.mate.presentation.helper.delegate
...
inline fun <reified T : ViewBinding> Fragment.viewBinding(
    noinline blockOnClear: T.() -> Unit = {},
) = FragmentViewBinding(T::class.java, this, blockOnClear)

class FragmentViewBinding<BindingClass : ViewBinding>(
    private val bindingClass: Class<BindingClass>,
    private val fragment: Fragment,
    private val blockOnClear: BindingClass.() -> Unit = {},
